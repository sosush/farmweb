...
import SatelliteImagery from '../../../greenguardian/components/satellite/SatelliteImagery';
...
const GreenGuardianSatelliteAnalysisPage: React.FC = () => {
...
export default GreenGuardianSatelliteAnalysisPage;