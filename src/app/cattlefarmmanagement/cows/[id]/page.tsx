...
import CowDetails from '../../../../cattlefarmmanagement/components/cows/CowDetails'; // Corrected casing
...
function CattleFarmManagementCowDetailsPage() {
  return (
    <ErrorProvider>
      <ErrorBoundary>
...
export default CattleFarmManagementCowDetailsPage;