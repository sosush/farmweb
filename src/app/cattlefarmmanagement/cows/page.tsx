...
import CowManagement from '../../../cattlefarmmanagement/components/CowManagement';
...
function CattleFarmManagementCowManagementPage() {
  return (
    <ErrorProvider>
      <ErrorBoundary>
...
export default CattleFarmManagementCowManagementPage;