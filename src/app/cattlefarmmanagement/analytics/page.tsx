...
import Analytics from '../../../cattlefarmmanagement/components/Analytics';
...
function CattleFarmManagementAnalyticsPage() {
  return (
    <ErrorProvider>
      <ErrorBoundary>
...
export default CattleFarmManagementAnalyticsPage;